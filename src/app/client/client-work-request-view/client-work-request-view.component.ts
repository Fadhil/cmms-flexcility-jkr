...
@Component({
  selector: 'app-client-work-request-view',
  templateUrl: './client-work-request-view.component.html',
  styleUrls: ['./client-work-request-view.component.scss']
})
export class ClientWorkRequestViewComponent implements OnInit {
